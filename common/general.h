...
namespace toptoken {
	...
	public:
		...
		const static char *toptoken_VERSION;
	...
	class SlowTimer : public utils::Singleton<toptoken::SlowTimer>, public utils::Runnable {
	public:
		SlowTimer();
		~SlowTimer();
	...
	class Global : public utils::Singleton<toptoken::Global>, public TimerNotify {
		asio::io_service io_service_;
